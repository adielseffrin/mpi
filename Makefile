...
MPI_CLINKER          = $(MPI_CC)
MPI_FLINKER          = $(MPI_F77)
MPE_CLINKER          = /home/adiel/mpe2/bin/mpecc -
MPE_FLINKER          = /home/adiel/mpe2/bin/mpefc -
#
DEBUG_LIBS           = 
MPI_CFLAGS           =  -g
MPI_FFLAGS           =  -g
...
CFLAGS               =  -g
FFLAGS               =  -g
MPE_INCDIR           = /home/adiel/mpe2/include
MPE_LIBDIR           = /home/adiel/mpe2/lib
MPE_SBINDIR          = /home/adiel/mpe2/sbin
...
linktest_C: 
	...
	@-$(MPE_SBINDIR)/mpetestlink matrizlog \
	  "*** Link C program with the MPI and manual logging libraries ............."
	@-echo ; $(MAKE) clean
...
runtest_C: 
	...
	@-$(MPE_SBINDIR)/mpetestexeclog matrizlog \
	  "*** Test C program with the MPI and manual logging libraries ............."
	@-echo ; $(MAKE) clean
